...
#export TEST_LDFLAGS +=  -lssl -lcrypto -lgcc_s -lc -luuid -lm -lrt -lpthread  -L/usr/local/lib -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -lSDL2  -lavdevice -lavformat -lavcodec -lavutil   -lv4l2
