...
#define THIS_FILE   "inv_offer_test.c"
#define PORT	    5068
#define CONTACT	    "sip:172.17.13.222:5068"
			...
			const pjmedia_sdp_session *offer)
{
    ...
    PJ_UNUSED_ARG(offer);
	TRACE_((THIS_FILE, "callback===========on_rx_offer"));
			    ...
			    pjmedia_sdp_session **p_offer)
{
	...
	TRACE_((THIS_FILE, "callback===========on_create_offer"));
...
{
    PJ_UNUSED_ARG(status);
	TRACE_((THIS_FILE, "callback===========on_media_update"));
...
static void on_state_changed(pjsip_inv_session *inv, pjsip_event *e)
{
    ...
    PJ_UNUSED_ARG(e);
	TRACE_((THIS_FILE, "callback===========on_state_changed %d", inv->state));
...
static void on_new_session(pjsip_inv_session *inv, pjsip_event *e)
{
    PJ_UNUSED_ARG(inv);
    PJ_UNUSED_ARG(e);
	TRACE_((THIS_FILE, "callback===========on_new_session"));
}
